...
def seed_dictionary_defaults(db: Session) -> None:
    ...
    defaults = {
        ...
        "priorities": [
            {"code": "Critical", "name": "Critical", "description": "Критический приоритет — должно быть выполнено", "color": "red-darken-2", "sort_order": 1},
            {"code": "High",     "name": "High",     "description": "Высокий приоритет — важно для основного функционала", "color": "orange-darken-1", "sort_order": 2},
            {"code": "Medium",   "name": "Medium",   "description": "Средний приоритет — желательно к выполнению", "color": "blue", "sort_order": 3},
            {"code": "Low",      "name": "Low",      "description": "Низкий приоритет — выполняется при наличии ресурсов", "color": "grey", "sort_order": 4},
        ],
        "lifecycle_statuses": [
            {"code": "extracted",    "name": "Извлечено",       "description": "Требование извлечено ИИ-агентом из документа",          "color": "grey",        "sort_order": 1},
            {"code": "verification", "name": "На верификации",  "description": "Проходит проверку инженером / менеджером",              "color": "orange",      "sort_order": 2},
            {"code": "accepted",     "name": "Принято",         "description": "Требование верифицировано и принято",                   "color": "green",       "sort_order": 3},
            {"code": "assigned",     "name": "Назначено",       "description": "Назначен ответственный исполнитель",                    "color": "blue",        "sort_order": 4},
            {"code": "in_progress",  "name": "В работе",        "description": "Исполнитель приступил к выполнению",                    "color": "cyan",        "sort_order": 5},
            {"code": "completed",    "name": "Выполнено",       "description": "Работа по требованию завершена",                        "color": "teal",        "sort_order": 6},
            {"code": "closed",       "name": "Закрыто",         "description": "Требование закрыто, жизненный цикл завершён",           "color": "blue-grey",   "sort_order": 7},
        ],
        "statuses": [
