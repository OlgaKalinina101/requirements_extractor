...
def seed_dictionary_defaults(db: Session) -> None:
    ...
    defaults = {
        ...
        "lifecycle_statuses": [
            {"code": "draft",       "name": "Draft",       "description": "Черновик — требование сформулировано, но не проверено",  "color": "grey",   "sort_order": 1},
            {"code": "in_review",   "name": "In Review",   "description": "На рассмотрении — проходит экспертную оценку",           "color": "orange", "sort_order": 2},
            {"code": "approved",    "name": "Approved",    "description": "Утверждено — принято как официальное требование",        "color": "green",  "sort_order": 3},
            {"code": "implemented", "name": "Implemented", "description": "Реализовано — разработка завершена",                     "color": "blue",   "sort_order": 4},
            {"code": "verified",    "name": "Verified",    "description": "Верифицировано — соответствие требованию подтверждено",  "color": "teal",   "sort_order": 5},
            {"code": "rejected",    "name": "Rejected",    "description": "Отклонено — требование исключено из области охвата",     "color": "red",    "sort_order": 6},
        ],
        "statuses": [
